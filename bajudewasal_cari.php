  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Daftar Dekorasi Bertema Rumah Sederhana</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="index.php">Home</a></li>
        <li>Daftar Dekorasi Rumah Sederhana</li>
      </ul>
    </div>
  </div>
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
			...
			$jenis=$_POST['jenis'];
			$sql = "SELECT * FROM baju WHERE id_jenis='$jenis' AND kategori='Rumah Sederhana'";
			$query = mysqli_query($koneksidb,$sql);
			$cnt = mysqli_num_rows($query);
			?>
			<p><span><?php echo htmlentities($cnt);?> Dekorasi Ditemukan</span></p>
			</div>
		</div>

<?php 
$sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND jenis.id_jenis='$jenis' AND baju.kategori='Rumah Sederhana'";
          ...
          <div class="recent_addedcars">
			...
			<?php
				$sql2 = "SELECT baju.*,jenis.* FROM baju,jenis 
						WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori ='Reumah Sederhana' ORDER BY baju.id_baju DESC limit 4";
