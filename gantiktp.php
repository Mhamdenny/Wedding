				...
				<div class="row">
					<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Foto KTP Details</div>
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">

											<div class="form-group">
											<label class="col-sm-4 control-label">Foto KTP Sekarang</label>
												<div class="col-sm-8">
											...
											<label class="col-sm-4 control-label">Upload Foto KTP Baru<span style="color:red">*</span></label>
												<div class="col-sm-8">
