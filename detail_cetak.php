...
<head>
	...
	<link href="admin/img/dw.png" rel="icon" type="images/x-icon">
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="admin/img/dw2.jpg" alt="logo-dkm" width="80" />
						</td>
						<td class="text-center"><h3>D E N'S WEDDING</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : +62 823-2275-3411 | E-mail : dens.wedding@gmail.com</td>
					</tr>
					<tr>
