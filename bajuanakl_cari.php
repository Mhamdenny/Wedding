  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Daftar Dekorasi Bertema Mewah Rumah</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="index.php">Home</a></li>
        <li>Daftar Dekorasi Mewah Rumah</li>
      </ul>
    </div>
  </div>
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
			...
			$jenis=$_POST['jenis'];
			$sql = "SELECT * FROM baju WHERE id_jenis='$jenis' AND kategori='Mewah Rumah'";
...
<?php 
$sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND jenis.id_jenis='$jenis' AND baju.kategori='Mewah Rumah'";
          ...
          <div class="recent_addedcars">
			...
			<?php
				$sql2 = "SELECT baju.*,jenis.* FROM baju,jenis 
						WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori ='Mewah Rumah' ORDER BY baju.id_baju DESC limit 4";
