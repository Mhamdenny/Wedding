...
$sql = "SELECT id_baju FROM baju WHERE kategori='Mewah Gedung'";
...
<?php 
$sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori='Mewah Gedung'";
          ...
          <div class="recent_addedcars">
			...
			<?php
				$sql2 = "SELECT baju.*,jenis.* FROM baju,jenis 
						WHERE baju.id_jenis=jenis.id_jenis AND kategori='Mewah Gedung' ORDER BY baju.id_baju DESC limit 4";
