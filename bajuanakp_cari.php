...
<section class="page-header listing_page">
  <div class="container">
    <div class="page-header_wrap">
      ...
      <h1>Daftar Dekorasi Bertema Mewah Gedung</h1>
      </div>
      <ul class="coustom-breadcrumb">
      <li><a href="index.php">Home</a></li>
        <li>Daftar Dekorasi mewah Gedung</li>
      </ul>
    </div>
  </div>
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
			...
			$jenis=$_POST['jenis'];
			$sql = "SELECT * FROM baju WHERE id_jenis='$jenis' AND kategori='Mewah Gedung'";
...
<?php 
$sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND jenis.id_jenis='$jenis' AND baju.kategori='Mewah Gedung'";
          ...
          <div class="recent_addedcars">
			...
			<?php
				$sql2 = "SELECT baju.*,jenis.* FROM baju,jenis 
						WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori ='Mewah Gedung' ORDER BY baju.id_baju DESC limit 4";
